...
/* I N I T I A T E   S C R O L L M A G I C */
...
$(function() {
    ...
    $(function() {
        ...
        $('.second-app-nav').append('<span class="other_pc_nav" style="font-family:AkkuratPro-Bold;padding: 0 20px;"><span style="border-left:2px solid #242728;height: 24%;margin-top: 24px;"></span></span><a cat="pdp_cta_click" act="product_switch_button" lab="HUAWEI P30" class="other_pc_nav a-common" href="/' + siteCode + '/phones/p30" style="float: left;height: 64px;line-height: 64px;font-family:akkuratPro-regular;font-size: 20px;color: #979696;">HUAWEI P30</a>');
        $('.second-ul').append('<li class="other_mobile_nav" style="border: 0; margin-bottom: 0;margin-top: 30px;"><a class="a-common" cat="pdp_cta_click" act="product_switch_button" lab="HUAWEI P30" href="/' + siteCode + '/phones/p30" style="font-family: AkkuratPro-Bold;line-height: 14px; font-size: 16px; height: auto; color: #242728;">HUAWEI P30</a></li>');
    ...
    $(".p30-section").each(function() {
        ...
        var p30SectionDuration =
            window.innerHeight * 1.5 + p30Section.outerHeight(true);
    ...
    $(window)
        .resize(function() {
            ...
            animatePerspective(elPerspective, triggerPerspective);
        })
        .resize();
    ...
    if (isFF) {
        ...
        console.dir("clip-path " + p30clipPathSupport);
        console.dir("sticky " + p30stickySupport);
    } else if (isIE || isIE11) {
    ...
    var p30IntroCameraAnimation = new TimelineMax().add([
        ...
        TweenMax.to(".intro-camera-curtainbg", 1, {
            css: {
                opacity: 0
            },
            ease: Linear.easeNone
    ...
    var p30IntroLogo = new ScrollMagic.Scene({
        ...
        .setTween("#p30-intro-camera-logo", {
            opacity: "1"
        })
        .addTo(controller);
    ...
    var lvIntroColors1 = new ScrollMagic.Scene({
            triggerElement: "#p30-intro-colors-01-trigger",
            duration: "150%",
            triggerHook: 0.5
        })
        .setClassToggle("#p30-intro-colors", "p30-intro-colors-slide1")
        .addTo(controller);

      var lvIntroColors1Color = new ScrollMagic.Scene({
          triggerElement: "#p30-intro-colors-01-trigger",
          duration: "100%",
          triggerHook: 0
      })
      .setTween("#p30-intro-colors-showcase", {
          backgroundColor: "rgb(215,250,250)"
      })
      .addTo(controller);

  var lvIntroColors2 = new ScrollMagic.Scene({
          triggerElement: "#p30-intro-colors-02-trigger",
          duration: "150%",
          triggerHook: 0.5
      })
      .setClassToggle("#p30-intro-colors", "p30-intro-colors-slide2")
      .setTween("#p30-intro-colors-showcase", {
          backgroundColor: "rgb(244,243,243)"
      })
      .addTo(controller);

  var lvIntroColors3 = new ScrollMagic.Scene({
          triggerElement: "#p30-intro-colors-03-trigger",
          duration: "200%",
          triggerHook: 0.5
      })
      .setClassToggle("#p30-intro-colors", "p30-intro-colors-slide3")
      .setTween("#p30-intro-colors-showcase", {
          backgroundColor: "rgb(244,243,243)"
      })
      .addTo(controller);
  ...
  var introColors = new ScrollMagic.Scene({
          triggerElement: "#p30-intro-colors-trigger",
          duration: "450%",
          triggerHook: 0.5
      })
      .setClassToggle("#p30-intro-colors", "animated")
      .addTo(controller);
    ...
    //zoom-moon
    var p30zoomMoonTM = new TimelineMax().add([
        TweenMax.fromTo("#p30-photo-zoom-moon", 1, {
            x: "-50%",
            y: "-50%",
            scale: "0.006"
        }, {
    ...
    var p30zoomMoon = new ScrollMagic.Scene({
            triggerElement: "#p30-photo-zoom-end-trigger",
            duration: "250%",
            triggerHook: 0
        })
        .setTween(p30zoomMoonTM)
        .addTo(controller);
    ...
    var p30zoomSlider = new ScrollMagic.Scene({
            triggerElement: "#p30-photo-zoom-end-trigger",
            duration: "250%",
            triggerHook: 0
        })
        .setTween("#p30-photo-zoom-slider-mask", {
            y: "-50%"
        })
        .addTo(controller);

    var p30zoomNumberPosition = new ScrollMagic.Scene({
            triggerElement: "#p30-photo-zoom-end-trigger",
            duration: "250%",
            triggerHook: 0
        })
        .setTween("#p30-photo-zoom-number", {
            y: "-54vh"
        })
        .addTo(controller);
    ...
    var p30zoomNumberText = new ScrollMagic.Scene({
            triggerElement: "#p30-photo-zoom-end-trigger",
            duration: "300%",
            triggerHook: 0
        })
        .setTween(Cont, 5, {
            ...
            roundProps: "val",
            onUpdate: function() {
                $("#p30-photo-zoom-number-update").text(Cont.val);
            }
        })
        .addTo(controller);
    ...
    var powerAnimatedSlider1trigger,
        ...
        powerAnimatedSlidertrigger,
        powerAnimatedSliderduration;
    if (screenWidth >= 600) {
        powerAnimatedSlider1trigger = 0.6;
        powerAnimatedSlider1duration = "100%";
        powerAnimatedSlidertrigger = 0.3;
        powerAnimatedSliderduration = "80%";
    } else {
        powerAnimatedSlider1trigger = 0.6;
        powerAnimatedSlider1duration = "70%";
        powerAnimatedSlidertrigger = 0.3;
        powerAnimatedSliderduration = "60%";
    }
    ...
    var powerSlider2 = new ScrollMagic.Scene({
            ...
            duration: powerAnimatedSliderduration,
            triggerHook: powerAnimatedSlidertrigger
        })
    ...
    //left-right end
    //video
    var integratedAIVideo = new ScrollMagic.Scene({
            triggerElement: "#integratedAIVideoContainer",
            duration: "100%",
            triggerHook: 0.5
        })
        .on("enter", function(e) {
            aiVideo.next().attr('class', 'middle-playbtn p30-tvc-title p30-playbtn')
            if (!huaweiBrowser) {
                aiVideo[0].play();
            }
            aiVideo.on('ended', function() {
                aiVideo.next().attr('class', 'middle-playbtn p30-tvc-title')
            })
        })
        .on("leave", function(e) {
            if (!huaweiBrowser) {
