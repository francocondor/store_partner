    ...
    <div class="box-list">
      ...
      <div class="box-items item-marca">
        ...
        <div id="marca" class="content-catalogo">
          <div class="title-select" v-on:click="toggleAccordionPromocion(filters[type].manufacturer)">
          ...
          <transition v-on:enter="transitionEnter" v-on:leave="transitionLeave">
            <div class="select-item" style="display: none"   v-show="filters[type].manufacturer.isOpen">
      ...
      <div class="box-items item-plan">
        ...
        <div id="plan" class="content-catalogo">
          <div class="title-select" v-on:click="toggleAccordionPromocion(filters[type].type)">
            <div class="btn-acordion"></div><span>Tipo de Plan</span>
            <div class="pull-right btl-caret" v-cloak>
              <span class="glyphicon glyphicon-menu-down" aria-hidden="true" v-show="!filters[type].type.isOpen"></span>
              <span class="glyphicon glyphicon-menu-up" aria-hidden="true" v-show="filters[type].type.isOpen"></span>

            </div>
          </div>
          <transition v-on:enter="transitionEnter"  v-on:leave="transitionLeave">
            <div class="select-item" style="display: none" v-show="filters[type].type.isOpen">
              <div class="item">
                <input id="prepaid" type="radio" name="type" value="1" {{Request::is('prepago') ? 'checked' : ''}}
                  v-on:change="redirect('prepago')">
                <label for="prepaid">Prepago</label>
              </div>
              <div class="item">
                <input id="postpaid" type="radio" name="type" value="2" {{Request::is('postpago') ? 'checked' : ''}}
                  v-on:change="redirect('postpago')">
                <label for="postpaid">Postpago</label>
              </div>
              <div class="item">
                <input id="promos" type="radio" name="type" value="3" {{Request::is('promociones') ? 'checked' : ''}}
                  v-on:change="redirect('promociones')">
      ...
      <div class="box-items item-precio-promocion">

        <div id="precio-equipo" class="content-catalogo">
          <div class="title-select" v-on:click="toggleAccordionPromocion(filters[type].price)">
            <div class="btn-acordion"></div><span>Precio de la promoción:</span>
            <div class="pull-right btl-caret" v-cloak>
          ...
          <transition v-on:enter="transitionEnter" v-on:leave="transitionLeave">
            <div class="select-item" style="display: none" v-show="filters[type].price.isOpen">
              <div class="item">
