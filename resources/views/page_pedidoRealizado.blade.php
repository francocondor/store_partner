        ...
        <div class="pedido-realizado__content">
          ...
          <div class="box-planes">
            <div class="box-planes__images">
              <img src="{{asset('css/chip@2x.jpg')}}" alt="chip">
            </div>
            <div class="box-planes__content">
              <h3 class="box-planes__title"><strong>Planes</strong> Plan control</h3>
              <div class="box-planes__detail">
                <div class="box-planes-modalidad">
                  <h4 class="box-planes-modalidad__title">Modalidad:
                ...
                <div class="box-planes-costos">
                  <div class="box-planes-costos__item box-planes-costos__item--simcard">
                    <span class="title">PRECIO DEL SIMCARD</span>
                    @if ($order['idtype_id'] == 4)
                    <p class="price">S/. {{$order['total']}}</p>
                    @else
