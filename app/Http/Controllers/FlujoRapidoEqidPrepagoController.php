...
class FlujoRapidoEqidPrepagoController extends Controller
{
  protected $shared;
  ...
  public function show(Request $request,$brand_slug,$product_slug,$affiliation_slug,$plan_slug,$contract_slug=null,$color_slug=null) {
    $inputs = [
    ...
    $productPost = $this->shared->productPostpaidBySlug($brand_slug,$product_slug,$affiliation_slug,$plan_slug,$contract_slug,$color_slug);
    ...
    $product_affiliations = $this->shared->getProductAffiliations($productPost);
