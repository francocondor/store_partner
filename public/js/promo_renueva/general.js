 ...
 $(document).ready(function() {
	$('#fullpage').fullpage({
        ...
        afterSlideLoad: function( anchorLink, index, slideAnchor, slideIndex){
            ...
            if(anchorLink == 'slide1'/* && slideIndex == 1*/){
	...
	$('.disabled-reserva').on('click', function(j) {
		j.preventDefault();
		/* Act on the event */
	});

	// $('.select-equipo a.azul').on('click',  function(event) {
	// 	event.preventDefault();
	// 	$('.select-equipo a').removeClass('active');
	// 	$(this).addClass('active')
	// 	$('.equipos').hide();
	// 	$('.equipos').removeClass('active');
	// 	$('.equipo-azul').addClass('active');
	// 	$('.equipo-azul').show();
	// 	/* Act on the event */
	// });
	// $('.select-equipo a.negro').on('click',  function(event) {
	// 	event.preventDefault();
	// 	$('.select-equipo a').removeClass('active');
	// 	$(this).addClass('active')
	// 	$('.equipos').hide();
	// 	$('.equipos').removeClass('active');
	// 	$('.equipo-negro').addClass('active');
	// 	$('.equipo-negro').show();
	// 	/* Act on the event */
	// });

	// function resizeequipos(){
    ...
    if (scrollTop == 0) 
	{
	    $("#navslide").addClass("top");
	}
	else{
	    $("#navslide").removeClass("top");
	}
	
	//alert(jQuery(window).width()+'height:'+jQuery(window).height());

});
 
},{"../../node_modules/aos/dist/aos.js":1,"aos":1,"bootstrap":2,"fullpage.js":15,"jquery":16}]},{},[17]);
...
$( "#materialInline2" ).click(function() {
  $(".radio-inline").removeClass("is-active");
  $(this).addClass("is-active");
  $("#reservalo-mobile").attr("onclick","{window.open('https://tienda.bitel.com.pe/postpago/meizu/m6t/portabilidad/ichip-plus-59_90/gold', '_blank');}");
  $( "#gold" ).show();
  $( "#black" ).hide();
});
...
$( "#materialInline1" ).click(function() {
  $(".radio-inline").removeClass("is-active");
  $(this).addClass("is-active");
  $("#reservalo-mobile").attr("onclick","{window.open('https://tienda.bitel.com.pe/postpago/meizu/m6t/portabilidad/ichip-plus-59_90/black', '_blank');}");
  $( "#gold" ).hide();
  $( "#black" ).show();
});