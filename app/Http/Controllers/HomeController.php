...
class HomeController extends Controller
{
  ...
  public function index(Request $request) {
    ...
    $metatags='
    <title>Tienda Online Bitel : postpago, prepago</title>
    <meta name="description" content="Equipos Móviles, smartphones, planes prepago, postpago y solo Plan, cámbiate a bitel, portabilidad, renovación y línea nueva." />
    <meta itemprop="image" content="'.asset('/images/meta_image/logo.png').'" />
    <meta property="og:url" itemprop="url" content="'.url()->current().'" />
    <meta property="og:title" content="Tienda Online Bitel : postpago, prepago" />
    <meta property="og:description" content="Equipos Móviles, smartphones, planes prepago, postpago y solo Plan, cámbiate a bitel, portabilidad, renovación y línea nueva." />
