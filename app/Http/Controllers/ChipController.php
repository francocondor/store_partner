...
class ChipController extends Controller
{
  ...
  public function index(Request $request) {
    ...
    $metatags='
    <title>Prepago Chips | Bitel Perú</title>
    <meta name="description" content="Prepago Chips | Conoce los beneficios que tenemos para ti en Tienda Bitel online y llévate hoy mismo tu iChip Prepago en Portabilidad, Renovación ó Línea Nueva" />
    <meta itemprop="image" content="'.asset('/images/meta_image/logo.png').'" />
    <meta property="og:url" itemprop="url" content="'.url()->current().'" />
    <meta property="og:title" content="Prepago Chips | Bitel Perú" />
    <meta property="og:description" content="Prepago Chips | Conoce los beneficios que tenemos para ti en Tienda Bitel online y llévate hoy mismo tu iChip Prepago en Portabilidad, Renovación ó Línea Nueva" />
