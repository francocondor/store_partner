            ...
            <div class="section-form">
              ...
              <div class="col-xs-12">
                <div class="form-group">
                  ...
                  <input id="first_name" type="text" name="first_name" placeholder="Nombres y apellidos del titular"
                    v-model="first_name" v-validate="'required|alpha_spaces|max:150'" maxlength="150"
                    :class="{'input': true, 'is-danger': errors.has('first_name')}"><i v-cloak
                    v-show="errors.has('first_name')" class="fa fa-warning"></i>
                  {{--<span v-show="errors.has('first_name')" class="help is-danger">@{{ errors.first('first_name') }}</span>--}}
                  <span v-cloak v-show="errors.has('first_name')" class="help is-danger">Sólo se permiten caracteres
                    alfabeticos</span>
                </div>
              </div>
              ...
              <div class="col-xs-12 col-sm-6">
                <div class="form-group form-select">
                  ...
                  <select id="document_type" name="document_type" v-model="document_type" v-validate="'required'"
              ...
              <div class="col-xs-12 col-sm-6">
                <div class="form-group">
                  ...
                  <input id="document_number" type="text" name="document_number" placeholder="Documento del titular"
                    ...
                    :class="{'input': true, 'is-danger': errors.has('document_number')}"><i v-cloak
                    v-show="errors.has('document_number')" class="fa fa-warning"></i>
                  <span v-if="document_type == 1" v-show="errors.has('document_number')" class="help is-danger"
                    v-cloak>Sólo se permiten 8 caracteres numéricos</span>
                  <span v-if="document_type == 2 || document_type == 3" v-show="errors.has('document_number')"
                    class="help is-danger" v-cloak>Sólo se permiten 12 caracteres alfanuméricos</span>
                </div>
              </div>
              ...
              <div class="col-xs-12 col-sm-6">
                  ...
                  <div class="form-group form-select">
                    ...
                    <select id="affiliation" disabled="" style="background-color:#e2e2e2">
                      ...
                      <option value="{{$affiliation->affiliation_id}}"
                        {{$affiliation->affiliation_id == $item['affiliation_id'] ? 'selected' : ''}}>
                        {{$affiliation->affiliation_name}}
                      </option>
                      @endforeach
                      @else
                      <select id="affiliation" name="affiliation" v-model="affiliation" v-validate="'required'"
                        :class="{'input': true, 'is-danger': errors.has('affiliation')}">
                ...
                <div class="col-xs-12 col-sm-6">
                  <div class="form-group">
                    ...
                    <input id="phone_number" type="text" name="phone_number" maxlength="9" v-model="phone_number"
                      v-validate="'required|numeric|min:9|max:9'"
                      :class="{'input': true, 'is-danger': errors.has('phone_number')}"><i v-cloak
                      v-show="errors.has('phone_number')" class="fa fa-warning"></i>
                    <span v-show="errors.has('phone_number')" class="help is-danger" v-cloak>Sólo se permiten 9
                      caracteres numéricos</span>
                  </div>
                </div>
                @endif
                ...
                <div class="col-xs-12 col-sm-6">
                  ...
                  <div class="form-group form-select">
                    ...
                    <div class="form-group form-select" v-if="affiliation == 1">
                      ...
                      <select id="type_number_carry" name="type_number_carry" v-model="type_number_carry"
                        v-validate="'required'" :class="{'input': true, 'is-danger': errors.has('type_number_carry') }">
                    ...
                    <div class="col-xs-12 col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group" v-if="affiliation == 1">
                          ...
                          <input id="porting_phone" type="text" name="porting_phone" maxlength="9"
                            ...
                            :class="{'input': true, 'is-danger': errors.has('porting_phone')}"><i v-cloak
                            v-show="errors.has('porting_phone')" class="fa fa-warning"></i>
                          {{-- <span v-show="errors.has('number_phone')" class="help is-danger">@{{ errors.first('number_phone') }}</span>
                          --}}
                          <span v-show="errors.has('porting_phone')" class="help is-danger" v-cloak>Por favor ingrese un
                            número telefónico móvil</span>
                        </div>
                        @endif
                      </div>
                      <div class="col-xs-12">
                      ...
                      <div class="col-xs-12 col-sm-6">
                        ...
                        <div class="form-group form-select" id="departamentodelivery">
                          ...
                          <select id=delivery_departament" name="delivery_departament" v-model="delivery_departament"
                            v-validate="'required'"
                            :class="{'input': true, 'is-danger': errors.has('delivery_departament')}"
                            @change="selectDepartamentd($event)">
                            <option value="" selected>Seleccione Departamento</option>
                            @foreach ($departamentos as $departamento)
                            <?php /*that means everything but no chips*/ /*if($category<4) { */
                            if($product_model=='P30' || $product_model=='P30 Pro'){
                              if($departamento->departament_name=='LIMA' || $departamento->departament_name=='CALLAO') {
                              ?>
                            <option value="{{$departamento->departament_id}}">{{$departamento->departament_name}}
                            </option>
                            <?php  
                              }
                            }
                            else if($product_model=='P30 Lite'){
                              if($departamento->departament_name=='LIMA' || $departamento->departament_name=='CALLAO' || $departamento->departament_name=='LA LIBERTAD') {
                                ?>
                            <option value="{{$departamento->departament_id}}">{{$departamento->departament_name}}
                            </option>
                            ?>
                      ...
                      <div class="col-xs-12 col-sm-6">
                        ...
                        <div class="form-group form-select" id="provinciadelivery">
                          ...
                          <provincesd-filtered v-if="delivery_provinces.length > 0"
                            :delivery_provinces="delivery_provinces" :deptprovdist="dept_prov_dist_branch_list">
                          </provincesd-filtered>
                          <div v-if="delivery_provinces.length == 0" id="delivery_provinces-select"
                            class="select-delivery_province">
                            <select id="delivery_province" name="delivery_province" v-model="delivery_province"
                              v-validate="'required'"
                      ...
                      <div class="col-xs-12 col-sm-6">
                        ...
                        <div class="form-group form-select" id="distritodelivery">
                          ...
                          <districtsd-filtered v-if="delivery_districts.length > 0"
                            :delivery_districts="delivery_districts" :deptprovdist="dept_prov_dist_branch_list">
                          </districtsd-filtered>
                          <div v-if="delivery_districts.length == 0" id="delivery_districts-select"
                            class="select-delivery_district">
                            <select id="delivery_district_1" name="delivery_district_1" v-model="delivery_district_1"
                              v-validate="'required'"
                      ...
                      <div class="col-xs-12 col-sm-6">
                        <div class="form-group">
                          ...
                          <input id="delivery_address" type="text" name="delivery_address" v-model="delivery"
                            v-init:delivery="{{array_get($order_detail,'delivery_address','')}}"
                            v-validate="{required: true, max: 150, regex: /^([a-zA-Z0-áéíóú9ñÑ#.,\s-]+)$/}"
                            maxlength="150" :class="{'input': true, 'is-danger': errors.has('delivery_address')}"><i
                            v-cloak v-show="errors.has('delivery_address')" class="fa fa-warning"></i>
                          <!--span v-show="errors.has('delivery')" class="help is-danger">@{{ errors.first('delivery') }}</span-->
                          <span v-show="errors.has('delivery_address')" class="help is-danger">Introduce una dirección
                            válida</span>
                          <p style="color: #8e8e8e;">Nota: Información de delivery sujeta a cobertura. Verificación
                      ...
                      <div class="col-xs-12 col-sm-6">
                        <div class="form-group">
                          ...
                          <input id="contact_phone" type="text" name="contact_phone" v-model="number_contact"
                            v-validate="'required|numeric|max:9'" maxlength="9"
                            :class="{'input': true, 'is-danger': errors.has('contact_phone')}"><i v-cloak
                            v-show="errors.has('contact_phone')" class="fa fa-warning"></i>
                          {{-- <span v-show="errors.has('number_contact')" class="help is-danger">@{{ errors.first('number_phone') }}</span>
                          --}}
                          <span v-show="errors.has('contact_phone')" class="help is-danger" v-cloak>Sólo se permiten
                            máximo 9 caracteres numéricos</span>
                        </div>
                      </div>
                      ...
                      <div class="col-xs-12 col-sm-6">
                        <div class="form-group">
                          ...
                          <input id="email" type="text" name="email" v-model="email"
                            ...
                            :class="{'input': true, 'is-danger': errors.has('email')}"><i v-cloak
                            v-show="errors.has('email')" class="fa fa-warning"></i>
                          {{-- <span v-show="errors.has('email')" class="help is-danger">@{{ errors.first('email') }}</span>
                          --}}
                          <span v-show="errors.has('email')" class="help is-danger" v-cloak>Introduce una dirección de
                            correo electrónico válida</span>
                        </div>
                      </div>
                      ...
                      <div class="col-xs-12 col-sm-6">
                        ...
                        <div class="form-group form-select">
                          ...
                          <select id=delivery_schedule" name="delivery_schedule" v-model="delivery_schedule"
                            v-validate="'required'"
                      ...
                      <div class="col-xs-12 col-sm-6">
                        <div class="form-group form-checkbox terminos-condiciones">
                          ...
                          <input id="terminos_condiciones" name="terminos_condiciones" type="checkbox"
                            v-validate="'required'" checked>
                          <!-- </label> -->
                          <a @click="terminoscondiciones($event)">Términos y condiciones</a>
                          <span class="help is-danger" v-show="errors.has('terminos_condiciones')"> (Debe aceptar los
                            términos y condiciones para poder realizar la compra).</span>
                        </div>
                      </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        “El usuario autoriza expresamente a Bitel a usar y tratar los datos personales que el titular proporciona en la
        página web y la contratación de servicios, así como en la información que se derive de su uso. El tratamiento de
        la información tiene como finalidad crear perfiles y enviar ofertas personalizadas de productos y servicios de
        la empresa y de terceros. El usuario ejercerá conforme a Ley, en cualquier momento, los derechos de información,
        acceso, actualización, inclusión, rectificación, cancelación y oposición sobre sus datos personales enviando una
        comunicación escrita a cualquier Centro de Atención Bitel ó llamando al 123.”
      </div>
...
<script type="text/javascript">
  document.addEventListener('DOMContentLoaded', function () {
    //hide initial validation of vue.js
    $(".fa.fa-warning").css("display","none");
