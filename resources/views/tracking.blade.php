              ...
              <div class="row">
                <div class="col-xs-6 col-sm-12 col-md-4 col-lg-4">
                  <div class="equipo-seleccionado">
                    <div class="image"><img src="{{asset(Storage::url($product->product_image_url))}}" alt="equipos">
                    </div>
                    <div class="contenido">
                      <h2 class="text-uppercase title-contenido">
                        <b>{{$product->brand_name}}</b> {{$product->product_model}}
                        {{isset($product->color_name) ? $product->color_name : ''}}
                      </h2>
                      ...
                      <p>
                        ...
                        <p>S/. {{$product->promo_price}} <span class="normal-price">S/.
                  ...
                  <div class="proceso">
                    <div id="nav-carrito" class="nav-carrito">
                      <ul class="list-unstyled">
                        @foreach($status_list as $status)
                        <li
                          class="col-xs-4 col-sm-4 {{$weight == $status->weight ? 'active' : ''}} {{$weight == 8 ? 'text-muted' : ''}} {{$weight < $status->weight ? '' : 'is-completed'}}">
