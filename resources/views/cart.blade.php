...
@endif
        ...
        <div class="col-xs-12 col-sm-10 col-sm-offset-1">
          <div id="detalle-carrito">
            ...
            <div class="main-detalle col-offset">
              <div class="row">
                <div class="col-xs-12 col-sm-4">
                  <p class="version-mobil text-right" style="
    color: #008c95;font-weight: 600">COSTO DE ENVÍO</p>
                </div>
                <div class="col-xs-12 col-sm-4"><span class="title-detalle">COSTO DE ENVÍO</span>
                  <p>GRATIS</p>
                </div>
              </div>
            </div>
            <div class="main-detalle col-offset">
              <div class="row">
                <div class="col-xs-12 col-sm-4">
                  <p class="version-mobil text-right" style="
    color: #008c95;font-weight: 600">TOTAL + IGV</p>
                </div>
    ...
    font-size: 16px;
">S/. {{ number_format($total + $equipo->plan_price, 2, '.', '') }}</span>
                    @else
                      <span style="
    font-weight: bold !important;
    font-size: 16px;
">S/. {{$total}}</span>
                    ...
                    @if($product->category_id<=3) 
                      <span style="font-size: 12px;display: block;">Pago de equipo<?php if($prepago==0){ ?> +<br>renta adelantada<?php } ?></span>
                    @else
                      <span style="font-size: 12px;display: block;">Precio de chip<?php if($prepago==0){ ?> +<br>renta adelantada<?php } ?></span>
                    @endif

                  </p>
                </div>
                <div class="col-xs-6 col-sm-4"><span class="title-detalle hidden-lg hidden-sm hidden-md" style="visibility:hidden
">MARGIN PARA MOVILES</span>
                  @if (isset($equipo) && intval($equipo->type_id) == 2)
            ...
            <div class="cons-cart">
              <p>* Al hacer click en "comprar" acepta las condiciones comerciales de Bitel, la renta adelantada y su prorrateo correspondiente. Un representante de ventas se comunicará contigo para brindarte todos los detalles sobre el Plan y el Pago de tu pedido.</p>
            </div>
