...
class FlujoArmaTuPlanController extends Controller
{
  protected $shared;
  ...
  public function index(Request $request) {
    ...
    // $infocomercial_product_plans = $this->shared->getInfocomercialProductPlansType2($product_plans_portabilidad);
    ...
    return view('armatuplan.index',$response);
  ...
  public function indexApi(Request $request) {
    ...
    $infocomercial_product_plans = $this->shared->getInfocomercialProductPlansType2($product_plans);
