    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="sub-heading">
          <h3 class="text-center" v-bind:class="{ opt1: bestSeller!='smartphone', opt2: bestSeller=='smartphone'}"><a
              href="javascript:void(0)" class="text-uppercase"
              v-on:click.prevent="toggleBestSeller('smartphone')">Postpago</a></h3>
          <h3 class="text-center" v-bind:class="{ opt1: bestSeller!='tablet', opt2: bestSeller=='tablet'}"><a
              href="javascript:void(0)" class="text-uppercase"
              v-on:click.prevent="toggleBestSeller('tablet')">Prepago</a></h3>
        </div>
          ...
          <div class="content-tab-pro" v-show="bestSeller=='smartphone'" key="smartphone">
            <div class="producto catalogo"><img src="{{$home_images[0]->image_url}}" alt="bitel">
              <div class="btn-catalogo">
                <div class="border-btn"><a href="{{$home_images[0]->image_link}}" class="btn btn-default">ver
                    catálogo</a></div>
              </div>
            </div>
