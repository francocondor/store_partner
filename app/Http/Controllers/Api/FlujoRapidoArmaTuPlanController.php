...
class FlujoRapidoArmaTuPlanController extends Controller
{
  ...
  public function showDefault($brand_slug,$product_slug,$affiliation_slug,$plan_slug,$contract_slug,$color_slug=null) {
  ...
  public function show($contactos,$megas) {
  ...
  $product_plans = $this->shared->getProductPlansChips($productPortbabilidad);
  
  $infocomercial_product_plans = $this->shared->getInfocomercialProductPlansType2($contactos,$megas );
  ...
  'productPlansInfoComercial' => $infocomercial_product_plans
  ];
