                ...
                <div class="container-section-new-information">
                        ...
                        <div id="image-equipo">
                          ...
                          <img id="zoom_01" src="{{asset(Storage::url($product_images[0]->product_image_url))}}" alt="{{$product->product_model}}">{{-- data-zoom-image="{{asset(Storage::url($product_images[0]->product_image_url))}}">--}}
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <img src="{{asset(Storage::url($image->product_image_url))}}"
                                            alt="{{$product->product_model}}">
                                    </li>
                                    @endforeach
                                </ul>
                  ...
                  @endif
                        ...
                        <a id="video-button" onclick="{$('video').get(0).play();$('#exampleModal').modal('show');}"
                            style="cursor:pointer;color: rgb(255, 255, 255);  background: rgb(0, 140, 149);padding: 5px;max-width: 130px;display: block;text-align: center;border-radius: 5%;">VER
                            VIDEO &nbsp;<span
                                ...
                                <div class="modal-content">
                                    <div class="modal-header" style="padding: 0;background: #2a2a2a;text-align:right">
                                        <button onclick="{$('video').get(0).pause();$('#exampleModal').modal('hide');}"
                                            style="right: 5px;z-index: 1;background: none;border: none;color: white;"
                                    ...
                                    <div style="padding: 0;height: 0;" class="modal-body">
                                        <video id="video" style="width:100%" preload="none" poster="" controls>
                                            <source
                                                src="/video/promo/<?php echo str_replace(" ","_",$product->product_model); ?>.mp4">
                                        </video>
                                    </div>
                                </div>
                            </div>
                            ...
                            <form form id="purchase-form" action="{{route('add_to_cart')}}" method="POST">
                                ...
                                <div class="content-product">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-3">
                                            <div id="box-color-product">
                                                @include('products.colors',['product' => $product, 'stock_models' =>
                                                $stock_models])
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-4">
                                            <div id="box-select-cambiate">
                                                ...
                                                <div class="select-product">
                                                    ...
                                                    <affiliations-filtered v-if="affiliations.length > 0"
                                                        :affiliations="affiliations" :product="product">
                                                    </affiliations-filtered>
                                                    <div v-if="affiliations.length == 0" id="affiliations-select"
                                                        class="select-affiliation {{$just_3 ? 'just-3' : ''}}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-7 col-12-mob"
                                    ...
                                    <postpaid-price v-if="Object.keys(product).length != 0" :product="product.product">
                                    </postpaid-price>
                ...
                <div class="descripcion-detalle">
                    <ul class="list-unstyled">
                        <li> <img src="/images/equipo/svg/android.svg" alt="android"><span
                                class="title-dispositivo">{{$product->product_os}}</span><span
                                class="description-dispositivo">Sistema Operativo</span></li>
                        <li> <img src="/images/equipo/svg/memoria.svg" alt="android"><span
                                class="title-dispositivo">Memoria
                                Interna
                    ...
                    echo strval($product->product_internal_memory*1000).' MB';
                        ...
                        <li> <img src="/images/equipo/svg/camara.svg" alt="android"><span
                                ...
                                MP / {{$product->product_camera_2}} MP</span><span
                                class="description-dispositivo">Cámara</span></li>
                ...
                <div class="producto">
                    ...
                    <div class="content-product text-center">
                        ...
                        <div class="btn-product">
                            <div class="btn-comprar"><a href="{{$item->route}}" class="btn btn-default">Me interesa</a>
                            </div>
                        </div>
                    </div>
                </div>
