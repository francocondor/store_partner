    ...
    <div class="box-list">
      ...
      <div class="box-items item-marca">
        <div id="marca" class="content-catalogo">
          <div class="title-select" v-on:click="toggleAccordionPrepago(filters[type].manufacturer)">
      ...
      <div class="box-items item-plan">
        <div id="plan" class="content-catalogo">
          <div class="title-select" v-on:click="toggleAccordionPrepago(filters[type].type)">
            <div class="btn-acordion"></div><span>Tipo de Plan</span>
            <div class="pull-right btl-caret" v-cloak>
              <!-- <span class="glyphicon " :class="filters[type].type.isOpen ? 'glyphicon-chevron-up' : 'glyphicon-chevron-down'"
      ...
      <div class="box-items item-precio">
        <div id="precio-equipo" class="content-catalogo">
          <div class="title-select" v-on:click="toggleAccordionPrepago(filters[type].price)">
