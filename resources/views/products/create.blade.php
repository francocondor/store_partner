      ...
      <div class="col-xs-12">
        <form class="" action="{{route('product.store')}}" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="product-name" name="name" placeholder="Ingresa el nombre"
              value="{{ old('name') }}">
            <!-- <p class="help-block">Help text here.</p> -->
          </div>
          <div class="form-group">
            <label for="product-price">Precio</label>
            <input type="text" class="form-control" id="product-price" name="price" placeholder="Ingresa el precio"
              value="{{ old('price') }}">
            <!-- <p class="help-block">Help text here.</p> -->
          </div>
          <div class="form-group">
            <label for="product-brand">Marca</label>
            <input type="text" class="form-control" id="product-brand" name="brand" placeholder="Ingresa la marca"
              value="{{ old('brand') }}">
            <!-- <p class="help-block">Help text here.</p> -->
          </div>
          <hr>
