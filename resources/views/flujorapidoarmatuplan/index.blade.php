    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12">
                @if($nameSlugPlan)
                <div class="message-plan" id="message-plan" v-show="activePathArmaTuPlan" style="display:none">
                    <p style="margin: 0;text-align: center;margin-top: 60px;"><span><img
                                src="/images/armatuplan/check-white.svg" alt=""></span>Este es el plan que se adecua
                        a tus necesidades</p>
                </div>
                @endif
                            ...
                            <div class="section-planes__tab">
                                <ul>
                                    ...
                                    <li v-bind:class="{ active: setActive == '{{$afiliacion->affiliation_slug}}' }"
                                        ...
                                        <a href="#"
                                            @click.prevent="selectToTabArmaTuPlan('{{$afiliacion->affiliation_slug}}', {{$afiliacion->affiliation_id}}, '{{$plan->plan_id}}')">
                                    ...
                                    <li v-bind:class="{ active: setActive == 'prepago' }"
                                        ...
                                        <a href="#"
                                            @click.prevent="selectToTabArmaTuPlan('prepago', 4, '15')">Prepago</a>
                                    </li>
                                </ul>
                            </div>
