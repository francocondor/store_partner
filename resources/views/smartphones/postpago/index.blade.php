...
<div class="section-list-new-products section-list-postpago">


  <div class="box-popup-filter box-popup-filter-postpago" style="display: none">
              ...
              <div class="box-items item-plan">
                <div id="precio-plan" class="content-catalogo">
                  ...
                  <div class="select-item" v-show="!filters[type].plan.isOpen">
                    ...
                    <div class="item">
                      <input id="plan-opt-{{$plan->plan_id}}" type="radio" name="plan" value="{{$plan->plan_id}}"
                        v-model="filters[type].plan.value" v-on:change="searchProduct(1)">
  ...
  <div class="box-header">
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          @include('layouts.sidebar.sidebar_postpago_catalogo')
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="col-xs-12 col-sm-12">
          <div id="list-equipos" v-cloak>
            ...
            <div class="row" v-if="searchResult.length > 0">
              <postpaid v-for="(product, index) in searchResult" :product="product" :base-url="baseUrl" :compare="compare"
                v-on:additem="addItem" v-on:removeitem="removeItem" :key="product.product_id"></postpaid>
            </div>
            <div class="row" v-if="!search">
                    ...
                    <div class="btn-product form-inline">
                      <div class="form-group btn-comprar">
                        <a href="{{route('postpaid_detail', [
                          ...
                          class="btn btn-default">ME INTERESA</a>
            ...
            <compare-postpaid v-if="compare.length > 0" v-bind:base-url="baseUrl" v-bind:products="compare"
              v-on:removeitem="removeItem"></compare-postpaid>
          </div>
        </div>
      </div>
    </div>
